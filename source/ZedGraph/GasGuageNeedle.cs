...
namespace ZedGraph
{
	...
	#region Fields
		...
		/// <see cref="GasGuageNeedle"/>. Use the public property <see cref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill _fill;
		...
		/// <see cref="GasGuageNeedle"/>
		/// </summary>
		private TextObj _labelDetail;

		/// <summary>
		/// Private field that stores the <see cref="Border"/> class that defines the
		/// properties of the border around this <see cref="GasGuageNeedle"/>. Use the public
		/// property <see cref="Border"/> to access this value.
		/// </summary>
		private Border _border;

		/// <summary>
		/// The bounding rectangle for this <see cref="GasGuageNeedle"/>.
		/// </summary>
		private RectangleF _boundingRectangle;

		/// <summary>
		/// Private field to hold the GraphicsPath of this <see cref="GasGuageNeedle"/> to be
	...
	#region Constructors
		...
		/// <summary>
		/// Create a new <see cref="GasGuageNeedle"/>
		/// </summary>
		/// <param name="label">The value associated with this <see cref="GasGuageNeedle"/>
		/// instance.</param>
		/// <param name="color">The display color for this <see cref="GasGuageNeedle"/>
		/// instance.</param>
		/// <param name="val">The value of this <see cref="GasGuageNeedle"/>.</param>
		public GasGuageNeedle( string label, double val, Color color )
			: base( label )
		{
			NeedleValue = val;
			NeedleColor = color;
		...
		/// </summary>
		/// <param name="ggn">The <see cref="GasGuageNeedle"/> object from which to copy</param>
		public GasGuageNeedle( GasGuageNeedle ggn )
			: base( ggn )
		{
		...
		public GasGuageNeedle Clone()
		{
			return new GasGuageNeedle( this );
		}
	...
	#region Properties
		...
		/// <summary>
		/// Gets or Sets the NeedleWidth of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the Border of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the SlicePath of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the LableDetail of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the NeedelColor of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the Fill of this <see cref="GasGuageNeedle"/>
		/// </summary>
		public Fill Fill
		{
			get { return _fill; }
		...
		/// <summary>
		/// Private property that Gets or Sets the SweepAngle of this <see cref="GasGuageNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the NeedleValue of this <see cref="GasGuageNeedle"/>
		/// </summary>
	...
	#region Serialization
		...
		/// </param>
		protected GasGuageNeedle( SerializationInfo info, StreamingContext context )
			: base( info, context )
		{
	...
	#region Default
		...
		/// <summary>
		/// Specify the default property values for the <see cref="GasGuageNeedle"/> class.
		/// </summary>
		public struct Default
		{
			...
			/// <summary>
			///Default value for controlling <see cref="GasGuageNeedle"/> display.
			/// </summary>
			public static bool isVisible = true;

//			/// <summary>
//			/// Default value for <see cref="GasGuageNeedle.LabelType"/>.
//			/// </summary>
//			public static PieLabelType LabelType = PieLabelType.Name;

			/// <summary>
			/// The default font size for <see cref="GasGuageNeedle.LabelDetail"/> entries
	...
	#region Methods
		...
		/// <summary>
		/// Do all rendering associated with this <see cref="GasGuageNeedle"/> item to the specified
		...
		/// <summary>
		/// Render the label for this <see cref="GasGuageNeedle"/>.
		/// </summary>
		/// <param name="g">
		/// A graphic device object to be drawn into. This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
		...
		/// PaintEventArgs argument to the Paint() method.
		/// </param>
		/// <param name="rect">Bounding rectangle for this <see cref="GasGuageNeedle"/>.</param>
		...
		/// <summary>
		/// Calculate the values needed to properly display this <see cref="GasGuageNeedle"/>.
		/// </summary>
		/// <param name="pane">
		/// A graphic device object to be drawn into. This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
		...
		public static void CalculateGasGuageParameters( GraphPane pane )
		{
			...
			foreach ( CurveItem curve in pane.CurveList )
			{
				if ( curve is GasGuageNeedle )
				{
					GasGuageNeedle ggn = (GasGuageNeedle)curve;
		...
		public static RectangleF CalcRectangle( Graphics g, GraphPane pane, float scaleFactor, RectangleF chartRect )
		{
			...
			GasGuageNeedle.CalculateGasGuageParameters( pane );
