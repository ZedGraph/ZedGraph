...
namespace ZedGraph
{
	...
	[Serializable]
	class DateAsOrdinalScale : Scale, ISerializable
	{

	#region constructors

		public DateAsOrdinalScale( Axis parentAxis )
			: base( parentAxis )
		{
		}
		...
		public DateAsOrdinalScale( Scale rhs )
			: base( rhs )
		{
		}
		...
		/// </summary>
		/// <returns>A new, independent copy of the <see cref="DateAsOrdinalScale" /> object.</returns>
		public object Clone()
		{
			return new DateAsOrdinalScale( this ); 
		}
