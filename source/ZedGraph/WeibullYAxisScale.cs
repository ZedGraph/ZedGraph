...
{
	/// <summary>
	/// The WeibullYAxisScale class inherits from the <see cref="Scale" /> class, and implements
	/// the features specific to <see cref="AxisType.Log" />.
	/// </summary>
	/// <remarks>
	/// WeibullYAxisScale is a non-linear axis in which the values are scaled using the base 10
	...
	[Serializable]
	class WeibullYAxisScale : Scale, ISerializable //, ICloneable
	{
	...
	#region constructors
		...
		public WeibullYAxisScale( Axis owner )
			: base( owner )
		{
		}
		...
		/// </summary>
		/// <param name="rhs">The <see cref="WeibullYAxisScale" /> object from which to copy</param>
		/// <param name="owner">The <see cref="Axis" /> object that will own the
		/// new instance of <see cref="WeibullYAxisScale" /></param>
		public WeibullYAxisScale( Scale rhs, Axis owner )
			: base( rhs, owner )
		{
		}
		...
		{
			return new WeibullYAxisScale( this, owner );
		}
	...
	#region Serialization
		...
		/// </param>
		protected WeibullYAxisScale( SerializationInfo info, StreamingContext context ) : base( info, context )
		{
